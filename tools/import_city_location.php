<?php
	...
	/* data config */
	$table_source_file = "city_location.csv";
	$table_name = "city_locations";
	$table_colums = 9;
	/*                                        name_in_table      pos_in_csv_file   */
	$table_field_config = array ( 	0 => array( "name" => "locId", "csv_pos" => 0),
					1 => array( "name" => "country", "csv_pos" => 1),
					2 => array( "name" => "region", "csv_pos" => 2),
					3 => array( "name" => "city", "csv_pos" => 3),
					4 => array( "name" => "postalCode", "csv_pos" => 4),
					5 => array( "name" => "latitude", "csv_pos" => 5),
					6 => array( "name" => "longitude", "csv_pos" => 6),
					7 => array( "name" => "metroCode", "csv_pos" => 7),
					8 => array( "name" => "areaCode", "csv_pos" => 8)
					);
