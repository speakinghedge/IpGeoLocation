<?php
	...
	/* data config */
	$table_source_file = "GeoIPCountryWhois.csv";
	$table_name = "ip_country_whois";
	$table_colums = 6;
	/*                                        name_in_table      pos_in_csv_file   */
	$table_field_config = array ( 	0 => array( "name" => "startIpStr", "csv_pos" => 0),
					1 => array( "name" => "endIpStr", "csv_pos" => 1),
					2 => array( "name" => "startIpNum", "csv_pos" => 2),
					3 => array( "name" => "endIpNum", "csv_pos" => 3),
					4 => array( "name" => "country_code", "csv_pos" => 4),
					5 => array( "name" => "country", "csv_pos" => 5)
					);
